...
<div id="sub">
     <div><img src="/Farmstory2/images/sub_top_tit1.png" alt="INTRODUCTION"></div>
     <section class="introduction">
         <aside>
             <img src="/Farmstory2/images/sub_aside_cate1_tit.png" alt="팜스토리 소개"/>

             <ul class="lnb">
                 <li class="on"><a href="./hello.html">인사말</a></li>
                 <li><a href="/Farmstory2/direction.html">찾아오시는 길</a></li>
             </ul>

         </aside>
         <article>
             <nav>
                 <img src="/Farmstory2/images/sub_nav_tit_cate1_tit1.png" alt="인사말"/>
                 <p>
             ...
             <!-- 내용 시작 -->
             <img src="/Farmstory2/images/sub_page1_article_txt.png" alt="건강한 먹거리를 위해 노력합니다.">
